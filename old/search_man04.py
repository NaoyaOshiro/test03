...
def union_video_channel_detail(video_id_ranking_list, channel_id_ranking_list):
    ...
    print(type(len(video_id_ranking_list)))

    # for cnt in range(len(video_id_ranking_list)):
    #     print(video_id_ranking_list[cnt])
    #     print('----')
    #     print(channel_id_ranking_list[cnt])
    #     print('--------------')

        # {'video_detail':video_id_ranking_list[cnt], 'channel_detail':channel_id_ranking_list[cnt]}

        # a = {'video_detail':video_id_ranking_list[cnt], 'channel_detail':channel_id_ranking_list[cnt]}
        # print(a)
        # print('--------------')
        # ここからへんから。動画とチャンネルを一つのリストにまとめるところから-------------------------------------------------------------------------------------------------------------
        # video_channel_detail_ranking_list.append(a)


    # for i in video_channel_detail_ranking_list:
    #     print(i.keys())
...
if __name__ == "__main__":
    ...
    # 「動画の詳細」と「チャンネルの詳細」を結合
    # union_video_channel_detail(video_detail_ranking_list, channel_detail_ranking_list)
